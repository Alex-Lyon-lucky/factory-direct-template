      ...
      <div className="max-w-[1600px] mx-auto px-12 mt-12">
        ...
        {activeTab === 'home' && (
          <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {/* 2. 分类装修 */}
            <div className="bg-white p-12 rounded-[56px] shadow-sm border border-slate-100">
               <h3 className="text-xl font-black uppercase text-slate-900 mb-10 flex items-center gap-4"><i className="fas fa-th-large text-emerald-600"></i> 产品分类模块 (3/5 布局)</h3>
               <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
                  <input type="text" placeholder="板块标题" value={localPages.home.categoryTitle} onChange={e => setLocalPages({...localPages, home: {...localPages.home, categoryTitle: e.target.value}})} className="bg-slate-50 border-none rounded-2xl px-6 py-4 font-black text-sm" />
                  <input type="text" placeholder="板块副标题" value={localPages.home.categorySubtitle} onChange={e => setLocalPages({...localPages, home: {...localPages.home, categorySubtitle: e.target.value}})} className="bg-slate-50 border-none rounded-2xl px-6 py-4 font-medium text-sm" />
               </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
               <div className="bg-white p-12 rounded-[56px] shadow-sm border border-slate-100">
                  <h4 className="font-black uppercase text-xs text-slate-900 mb-8">工厂实力数据</h4>
               ...
               <div className="bg-white p-12 rounded-[56px] shadow-sm border border-slate-100">
                  ...
                  <div className="space-y-4">
                     <input type="text" placeholder="视频 URL" value={localPages.home.videoUrl} onChange={e => setLocalPages({...localPages, home: {...localPages.home, videoUrl: e.target.value}})} className="w-full bg-slate-50 border-none rounded-xl px-4 py-3 text-xs font-medium" />
                     <input type="text" placeholder="视频标题" value={localPages.home.videoTitle} onChange={e => setLocalPages({...localPages, home: {...localPages.home, videoTitle: e.target.value}})} className="w-full bg-slate-50 border-none rounded-xl px-4 py-3 text-sm font-black" />
                     <textarea rows={2} placeholder="视频短评" value={localPages.home.videoDesc} onChange={e => setLocalPages({...localPages, home: {...localPages.home, videoDesc: e.target.value}})} className="w-full bg-slate-50 border-none rounded-xl px-4 py-3 text-xs" />
                  </div>
               </div>
            </div>
            ...
            <div className="bg-white p-12 rounded-[56px] shadow-sm border border-slate-100">
               <div className="flex justify-between items-center mb-10">
                  <h3 className="text-xl font-black uppercase text-slate-900">资质荣誉证书 (Trust Items)</h3>
            ...
            <div className="bg-white p-12 rounded-[56px] shadow-sm border border-slate-100">
               <div className="flex justify-between items-center mb-10">
                  <h3 className="text-xl font-black uppercase text-slate-900">FAQ 常见问题</h3>
                  <button onClick={() => setLocalPages({...localPages, home: {...localPages.home, faq: [...(localPages.home.faq || []), {q: '', a: ''}]}})} className="bg-blue-600 text-white px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest">添加问答</button>
               </div>
               <div className="space-y-4">
